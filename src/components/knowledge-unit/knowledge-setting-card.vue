        ...
        <div class="md:row-span-1">
          ...
          <div class="flex items-center space-x-4">
            <div class="w-20 h-20 rounded-md overflow-hidden border border-gray-300">
              <img v-if="localKbImageUrl" :src="localKbImageUrl" alt="封面图片" class="w-full h-full object-cover"
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="range" v-model.number="settings.textBlockSize" min="128" max="4096" step="128" class="w-full" />
      ...
      <div v-if="settings.extractKnowledgeGraph" class="pl-6 border-l-2 border-blue-100 space-y-4">
        ...
        <div>
          ...
          <div class="flex flex-wrap gap-2">
            <div v-for="entity in entityTypes" :key="entity.value" @click="toggleEntityType(entity.value)" :class="[
